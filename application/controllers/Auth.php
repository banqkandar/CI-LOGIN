...
class Auth extends CI_Controller {
        ...
        if  ($user) {
          ...
          Password salah!
           ...
           redirect('auth');
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
           Maaf, email ini belum diaktivasi!
         </div>');
           redirect('auth');
            }
    ...
    private function _sendEmail($token, $type) {
        $config = [
            ...
            'smtp_user' => 'share.pelajaran@gmail.com',
            'smtp_pass' => 'dirinyasendiri',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('share.pelajaran@gmail.com');
    ...
    public function changePassword() {
        ...
        $this->form_validation->set_rules('password1', 'Confirm Password', 'trim|required|min_length[3]|matches[password1]');
        if  ($this->form_validation->run() == false ) {
